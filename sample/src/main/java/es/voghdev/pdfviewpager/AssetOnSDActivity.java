...
import es.voghdev.pdfviewpager.library.PDFViewPager2;
...
public class AssetOnSDActivity extends BaseSampleActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pdfViewPager= (PDFViewPager2) findViewById(R.id.pdfViewPager);
//        pdfFolder = Environment.getExternalStorageDirectory();
        pdfFolder = Environment.getExternalStorageDirectory();
        path=pdfFolder.getPath()+"/test1.pdf";
        copyAssetsOnSDCard();

    }
    public void onclick(View view) {
        Log.e("qwer",pdfViewPager.count()+"");
    }
